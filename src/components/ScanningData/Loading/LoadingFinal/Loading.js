    ...
    render() {
        return (
            <Container>
                ...
                <Text style={{ fontFamily: "msyi", marginTop: '28%', maxWidth: '70%', fontSize: 28, color: 'white', margin: 35, display: 'flex' }}>
                    Estamos compartiendo su legajo con CAR DEALER, por favor aguarde un instante.
                </Text>
            </Container>
        );
    }
